export default {
  ...
  about: {
    ...
    methodology: {
      ...
      capsule: 'Traqcker turns free cash flow into a single quality-adjusted score for 50,000+ companies through four sequential calculation steps.',
      steps: [
        {
    ...
    tldr: {
      title: 'TL;DR',
      items: [
        'Traqcker scores 50,000+ public companies using a proprietary GARP-based, free-cash-flow-first framework.',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Traqcker covers 50,000+ publicly traded companies, with data sourced from SEC EDGAR filings and Finnhub.',
      },
      {
