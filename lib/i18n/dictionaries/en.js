export default {
  ...
  home: {
    ...
    stats: [
      { value: '260+', label: 'companies covered, scored the same way every time' },
      { value: 'SEC EDGAR + Finnhub', label: 'direct source data, not delayed press releases' },
      { value: '$0', label: 'to start. Upgrade only if the terminal earns it' },
    ],
    featuresEyebrow: 'What you get',
    featuresTitle: 'Four tools. Zero fluff.',
    methodologyEyebrow: 'How a score gets made',
    methodologyLink: 'See the full methodology →',
    pricingEyebrow: 'Pricing',
    pricingTitle: 'Start free. Upgrade when it pays for itself.',
    pricingLink: 'See full pricing →',
    finalCta: {
      title: 'Open a filing. See the score. Decide for yourself.',
      subtitle: 'No signup wall between you and the terminal.',
    },
    footer: {
  ...
  about: {
    hero: {
      ...
      subtitle: 'Bulltrace gives independent analysts and retail investors direct, unfiltered access to clean public company filings, financial scores, and portfolio analysis.',
    ...
    letter: {
      ...
      paragraphs: [
        ...
        'We believe independent researchers shouldn\'t have to spend thousands of dollars a year to access clean, direct financial data. At Bulltrace, we go straight to the primary source. We fetch files directly from regulatory bodies, compute margins transparently, and map them to historical visual models.',
        "When you evaluate a stock on Bulltrace, you don't just see a quality score. You can click on any metric to inspect the exact line in the company's financial reports. We believe in total transparency, facts over predictions, and absolute clarity.",
      ],
    },
    why: {
      eyebrow: 'WHY BULLTRACE EXISTS',
      items: [
    ...
    methodology: {
      ...
      title: 'The Bulltrace Score, step by step',
      capsule: 'Bulltrace turns free cash flow into a single quality-adjusted score for 260+ companies through four sequential calculation steps.',
      steps: [
        {
      ...
      survival: {
        ...
        desc: 'Rather than excluding unprofitable or early-stage companies from the screener, Bulltrace applies a dedicated Pre-FCF Survival Score designed to assess their viability on its own terms.',
      },
      sources: {
        title: 'Data sources: SEC EDGAR & Finnhub',
        capsule: 'Every Bulltrace score is grounded in primary financial statements pulled directly from SEC EDGAR filings and Finnhub, not estimates.',
    ...
    tldr: {
      title: 'TL;DR',
      items: [
        'Bulltrace scores 260+ public companies using a proprietary GARP-based, free-cash-flow-first framework.',
    ...
    team: {
      ...
      role: 'Founder',
      bio: 'Built Bulltrace out of frustration with tools that were either too expensive or too complex. Wanted something honest, simple, and actually useful for normal investors.',
    },
    finalCta: {
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        ...
        'Saved watchlist',
        'Analyst ratings on every stock',
      ],
    },
    proFeatures: [
      'Everything in Free',
    ...
    priceSuffixAnnual: '/month · billed $119.99/year',
  ...
  faq: {
    ...
    subtitle: 'Short, direct answers about what Bulltrace is, how the score works, and what it costs.',
    items: [
      {
        q: 'What is Bulltrace?',
        a: 'Bulltrace is an investment terminal for retail investors that combines a stock screener, portfolio tracking, and a news feed in one dashboard, using a GARP-based scoring system built on free cash flow.',
      },
      {
        q: "How does Bulltrace's scoring work?",
        a: 'Bulltrace scores each company in four steps: FCF Base Value, Quality Multiplier, Balance Sheet Adjustment, and Fundamentals Penalty. Companies with negative free cash flow get a Pre-FCF Survival Score instead.',
      },
      {
        q: 'How many companies does Bulltrace cover?',
        a: 'Bulltrace covers 260+ publicly traded companies, with data sourced from SEC EDGAR filings and Finnhub.',
      },
      {
        q: 'How much does Bulltrace cost?',
        a: 'Bulltrace is freemium: the free tier has capped features (some screener categories hidden, no non-US stock data until you create a free account). Full access includes a 14-day free trial with no credit card required, then $14.99/month or $119.99/year.',
      },
      {
        q: 'How is Bulltrace different from screeners like Simply Wall St or Finchat?',
        a: "Bulltrace is built specifically around GARP methodology with a proprietary cash-flow-based score, not generic multiples or traffic-light 'financial health' scores. It's a full terminal, not just a screener — portfolio tracking and a news feed live in the same interface.",
      },
      {
        q: 'Does Bulltrace work for companies with no profits or negative free cash flow?',
        a: 'Yes. Instead of excluding them, Bulltrace applies a Pre-FCF Survival Score designed to assess viability for early-stage or currently unprofitable companies.',
      },
      {
        q: 'Who built Bulltrace?',
        a: 'Bulltrace was built by Pablo (@pabloinvesting_), an independent investor and indie developer who also publishes equity research through Hawthorne & Fletcher Research.',
      },
      {
        q: 'Is there a free trial of Bulltrace?',
        a: "Yes — Bulltrace has a permanent, capped free tier, plus a 14-day free trial of full access that doesn't require a credit card.",
      },
      {
        q: "What's included in Bulltrace's free tier?",
  ...
  startTrial: {
    ...
    annual: 'Annual · Save 33%',
    planName: 'PRO',
    priceSuffixAnnual: '/month · billed $119.99/year after your trial',
  ...
  success: {
    ...
    title: 'Welcome to Bulltrace Pro',
  ...
  privacy: {
    ...
    sections: [
      {
        title: '1. Who We Are',
        content: 'Bulltrace is operated as an independent project by Pablo Rodriguez, based in the United Kingdom. We operate the website bulltrace.app and related services. For data protection matters, contact us at hello@bulltrace.app.',
      },
      {
...
- Contract (Art. 6(1)(b)): to provide the Bulltrace service you have subscribed to, including account management and subscription billing.
...
We do not sell, rent, or share your personal data with third parties for marketing purposes.`,
      },
      {
        ...
        content: `We use the following third-party services to operate Bulltrace:
...
To exercise any of these rights, contact us at hello@bulltrace.app. We will respond within 30 days. You will not be charged for making a request.`,
      },
      {
      ...
      },
      {
        ...
        content: 'Bulltrace is not directed at children under the age of 13. We do not knowingly collect personal data from children. If you believe a child has provided us with personal data, please contact us at hello@bulltrace.app.',
      },
      {
      ...
      {
        title: '13. Contact Us',
        content: 'For any privacy-related questions or requests, contact us at hello@bulltrace.app. We aim to respond within 5 business days.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        content: 'By accessing or using Bulltrace ("the Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Service. These Terms constitute a legally binding agreement between you and Bulltrace, operated by Pablo Rodriguez, United Kingdom.',
      },
      {
        title: '2. Description of Service',
        content: `Bulltrace provides a web-based platform for fundamental stock analysis, including:
...
Nothing on Bulltrace constitutes investment advice, financial advice, trading advice, or any other type of advice. Bulltrace is an informational tool only.
...
- The Bulltrace Score and any other proprietary metrics are automated calculations and should not be relied upon as recommendations.
...
- Bulltrace is not authorised or regulated by the Financial Conduct Authority (FCA).`,
      },
      {
...
You must be at least 18 years old to create an account. We reserve the right to suspend or terminate accounts that violate these Terms.`,
      },
      {
        ...
        content: `Bulltrace offers the following plans:

Free Plan: Access to stock overviews, quality scorecards, market data, and sparklines. No payment required.

Pro Plan: Full access to all features including financial statements, DCF valuation, stock screener, compare tool, and watchlist. Available on monthly ($14.99/month) or annual ($119.99/year, equivalent to $9.99/month) billing cycles.
...
To request a refund, contact us at hello@bulltrace.app with your account email and reason for the request. We will process eligible refunds within 5-10 business days.`,
      },
      {
        title: '7. Intellectual Property',
        content: `All content on Bulltrace, including but not limited to the scoring methodology, design, code, text, and graphics, is the property of Bulltrace and protected by applicable intellectual property laws.
...
- Bulltrace shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, investment losses, or loss of data.
...
- Nothing in these Terms excludes or limits our liability for death or personal injury caused by negligence, fraud, or any other liability that cannot be excluded by law.`,
      },
      {
        ...
        content: 'You agree to indemnify and hold harmless Bulltrace and its operators from any claims, damages, losses, or expenses (including legal fees) arising from your use of the Service, your violation of these Terms, or your violation of any third-party rights.',
      },
      {
      ...
      {
        title: '15. Contact Us',
        content: 'For any questions about these Terms, contact us at hello@bulltrace.app. We aim to respond within 5 business days.',
      },
    ],
  },
};
