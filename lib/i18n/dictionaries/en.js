export default {
  ...
  home: {
    ...
    hero: {
      title: 'Other tools give you a score and ask you to trust it.',
      subtitle: "Traqcker's Quality Score and DCF valuation are built directly from SEC EDGAR filings and Finnhub data, not black-box estimates. A GARP-based terminal for investors who want to verify, not just believe.",
    },
    footer: {
  ...
  about: {
    ...
    letter: {
      ...
      paragraphs: [
        ...
        "When you evaluate a stock on Traqcker, you don't just see a quality score. Every stock page links straight to that company's SEC EDGAR filings, and every number is computed directly from them and from Finnhub data — never smoothed over or estimated. We believe in total transparency, facts over predictions, and absolute clarity.",
      ],
    },
    why: {
      ...
      items: [
        ...
        { title: 'Source Transparency', desc: "Every calculation on our platform is computed directly from SEC EDGAR filings and Finnhub data — no smoothed-over estimates or black-box scoring. Every stock page links straight to that company's official filings." },
    ...
    methodology: {
      ...
      capsule: 'Traqcker turns free cash flow into a single quality-adjusted score for 80,000+ companies across US and international markets, through four sequential calculation steps.',
      steps: [
        {
    ...
    tldr: {
      title: 'TL;DR',
      items: [
        'Traqcker scores 80,000+ public companies across US and international markets using a proprietary GARP-based, free-cash-flow-first framework.',
    ...
    finalCta: {
      ...
      subtitle: 'Create a free account for full DCF valuation, an uncapped screener, and full international data. No credit card required.',
      cta: 'Start free →',
    },
    footerNote: {
  ...
  pricing: {
    ...
    subtitle: 'Create a free account for full DCF valuation, an uncapped screener, and international data — no credit card. Upgrade to Pro for a multi-currency Portfolio tracker, full ETF coverage, and unlimited daily discovery.',
    monthly: 'Monthly',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Traqcker covers 80,000+ publicly traded companies across US and international markets — US financials sourced directly from SEC EDGAR filings, with global coverage from Finnhub.',
      },
      {
        q: 'How much does Traqcker cost?',
        a: 'Traqcker has three tiers: browse the terminal without an account (screener categories limited, US-only data), create a free account for full DCF valuation, the full screener, a watchlist, and international data, or go Pro for a multi-currency Portfolio tracker, full ETF coverage, and unlimited daily discovery. Pro includes a 14-day free trial with no credit card required, then $14.99/month or $119.99/year.',
      },
      {
      ...
      },
      {
        ...
        a: "Yes — you can browse Traqcker without an account for free, a free account unlocks full valuation tools and the full screener at no cost forever, and Pro comes with its own 14-day free trial that doesn't require a credit card.",
      },
      {
        q: "What's included in Traqcker's free tier?",
        a: 'Without an account you can browse the terminal and view stock pages, with some screener categories hidden and only US data. Creating a free account (still $0) unlocks the full screener, full DCF valuation, a watchlist, and international market data. Pro adds a multi-currency Portfolio tracker, full ETF coverage, and unlimited daily discovery.',
      },
    ],
  },
