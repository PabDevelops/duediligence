export default {
  ...
  home: {
    nav: { product: 'Product', pricing: 'Pricing', useCases: 'Use cases' },
    openApp: 'Open app',
    startFreeTrial: 'Start free',
    hero: {
      title: 'Institutional-grade stock research. Free to start.',
      subtitle: 'Direct SEC filings, DCF valuation, and a quantitative screener — unlocked the moment you create a free account. No credit card, ever, unless you choose Pro.',
      ctaPrimary: 'Create a free account →',
      ctaSecondary: 'Explore without signing up →',
    },
    tiers: {
      eyebrow: 'How it works',
      title: 'Start free. Upgrade only if you need more.',
      subtitle: 'No trial clock and no forced card on file — each step unlocks more of the terminal for free.',
      items: [
        {
          step: '01',
          title: 'Explore as a guest',
          desc: 'Browse the screener, stock pages, market radar, and earnings calendar with no account. The screener shows the 40 largest matches and your watchlist is a session-only scratchpad.',
        },
        {
          step: '02',
          title: 'Create a free account',
          desc: 'No card required. Unlocks full DCF valuation, price projections, Fair Value, the Quality Score, an uncapped screener, a saved watchlist, and community BUY / HOLD / SELL voting.',
        },
        {
          step: '03',
          title: 'Go Pro when you need it',
          desc: 'Add the multi-currency Portfolio tracker, full ETF coverage, and unlimited daily stock discovery — from $9.99/month billed annually.',
        },
      ],
      ctaFree: 'Create your free account →',
      ctaPro: 'See Pro plans →',
    },
    capabilities: {
      eyebrow: 'Built for research',
      title: 'Tools designed to verify, clarify, and speed up your process',
      terminal: {
        badge: 'FREE WITH AN ACCOUNT',
        title: 'Direct SEC Financials',
        tagline: 'Quantitative stock screening & modeling',
        desc: 'Filter thousands of global equities with no cap. Sign up free to unlock DCF valuation, price projections, and Benjamin Graham Fair Value computed directly from filings.',
        cta: 'Try the screener free →',
      },
      portfolio: {
        badge: 'PRO',
        title: 'Multi-Currency Portfolio Tracker',
        tagline: 'Real-time valuation across global assets',
        desc: 'Track positions, gain/loss, and sector allocation in your own reporting currency. Handles international tickers (like LLOY.L) with automatic pence/pound conversion. Included with Pro.',
        cta: 'See Pro plans →',
      },
    },
    valueProps: {
      eyebrow: 'Why Traqcker',
      title: 'Raw filings. Unbiased metrics. Clear insights.',
      subtitle: 'We build tools that focus on verification, clarity, and speed. Cut through the noise with primary source financial intelligence.',
      items: [
        {
          title: 'Be first',
    ...
    productTour: {
      ...
      title: 'Everything Traqcker offers, in one walkthrough',
      subtitle: "From your morning dashboard to a full valuation model, here's what a real session inside Traqcker looks like.",
      steps: [
        { title: 'Start with a live market snapshot', desc: "Your home dashboard opens with real-time indices, currency rates, and the day's biggest filings and price movers across your watchlist and portfolio." },
        { title: 'Track your holdings across currencies', desc: 'Your portfolio view rolls up gain/loss, sector allocation, and dividend income in one reporting currency, no matter what exchange each position trades on.' },
        { title: 'Drill into a single company', desc: 'Every quality score, margin, and Graham fair value on a stock page links straight back to the exact row in the original SEC filing.' },
        { title: 'Screen the entire market', desc: 'Filter and rank thousands of global equities by margin, free cash flow yield, debt profile, or dilution to find setups worth a closer look.' },
        { title: 'Scan the market with Radar', desc: 'Rank stocks by quality, valuation, and momentum, and track sector heatmaps, sentiment, and technical breakouts — a place to start when you don’t have a ticker in mind yet.' },
        { title: 'Never miss a catalyst', desc: 'The earnings calendar and live filing feed keep you ahead of reports, dividends, and SEC EDGAR alerts for everything on your radar.' },
      ],
      liveNote: "This isn't a mockup — it's the real app.",
      liveCta: 'See it live →',
    },
    finalCta: {
      title: 'Start free. See if it fits your process.',
      subtitle: 'Create a free account for full DCF valuation, projections, and an uncapped screener. No credit card required.',
