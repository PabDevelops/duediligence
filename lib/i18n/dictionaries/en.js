export default {
  ...
  home: {
    ...
    startFreeTrial: 'Start free trial',
    hero: {
      title: 'Professional investment analysis, powered by direct company filings.',
      subtitle: 'Direct SEC filings, normalized multi-currency portfolios, intrinsic valuation modeling, and community intelligence.',
      ctaPrimary: 'Start free 14-day Pro trial',
      ctaSecondary: 'Try it now, no signup →',
    },
    capabilities: {
      ...
      terminal: {
        ...
        desc: 'Filter thousands of global equities instantly. Compute margins, cash conversions, debt profiles, and Benjamin Graham intrinsic values directly from filings.',
        cta: 'Try the Terminal free →',
      },
      portfolio: {
        badge: 'PORTFOLIO & WATCHLIST',
        title: 'Multi-Currency Tracker',
        tagline: 'Real-time valuation across global assets',
        desc: 'Track positions, gain/loss, and sector allocation in your own reporting currency. Handles international tickers (like LLOY.L) with automatic pence/pound conversion.',
    ...
    finalCta: {
      title: 'Research faster. Value smarter.',
      subtitle: 'Join thousands of analysts. Try Traqcker Pro free for 14 days. No credit card required.',
  ...
  about: {
    ...
    finalCta: {
      ...
      subtitle: 'Try Traqcker Pro free for 14 days. No credit card required.',
  ...
  pricing: {
    ...
    titleLine1: 'Try Pro free for 14 days.',
    titleLine2: 'Cancel anytime.',
    subtitle: 'Full financials, screener, and compare tools — 14 days free, no card required to start.',
    monthly: 'Monthly',
    annual: 'Annual · Save 33%',
    badge: '14-DAY FREE TRIAL',
    planName: 'TRAQCKER PRO',
    priceSuffixAnnual: '/month · billed $119.88/year after trial',
    priceSuffixMonthly: '/month after trial',
    features: [
