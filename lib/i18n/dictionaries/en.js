export default {
  ...
  home: {
    ...
    hero: {
      ...
      subtitle: 'Direct SEC filings, normalized multi-currency portfolios, intrinsic valuation modeling, and community intelligence. Trusted by independent analysts worldwide.',
      ctaPrimary: 'Start free 14-day Pro trial',
      ctaSecondary: 'See product tour ↓',
    },
    trustedBy: 'Trusted by independent analysts & retail investors',
    capabilities: {
    ...
    productTour: {
      ...
      steps: [
        ...
        { title: 'Compare candidates side-by-side', desc: 'Line up two or more companies across the same fundamentals to see who actually has the stronger balance sheet and growth trajectory.' },
