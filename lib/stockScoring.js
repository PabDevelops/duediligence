...
// as either series' CV clears 0.25 or the 5-year margin trend is clearly deteriorating.
function computeStabilityFactor(data, years = 7) {
...
export function computeEasyMode(data, hasFundamentals) {
  ...
  const { factor: stabilityFactor, marginCV, roicCV } = computeStabilityFactor(data);
