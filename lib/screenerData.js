...
const SELECT_FIELDS = 'ticker, updated_at, name:data->name, sector:data->sector, exchange:data->exchange, currentPrice:data->currentPrice, priceChangePct:data->priceChangePct, marketCap:data->marketCap, pe:data->pe, beta:data->beta, revGrowth:data->revGrowth, opMargin:data->opMargin, fcfYield:data->fcfYield, roe:data->roe, netDebt:data->netDebt, grossMargin:data->grossMargin, fcfVal:data->fcfVal, revVal:data->revVal, eps:data->eps, shareDilution:data->shareDilution, insiderOwnershipPct:data->insiderOwnershipPct, cashVal:data->cashVal';
